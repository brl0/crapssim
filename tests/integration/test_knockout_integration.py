...
@pytest.mark.parametrize("point, last_roll, strat_info, bets_before, dice_result, bets_after", [
    ...
    (
        ...
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0)],
        (1, 4),
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 5, bet_amount=20.0)]
    ),
    (
        5, 3, None,
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 5, bet_amount=20.0)],
    ...
    (
        ...
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0)],
        (2, 4),
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 6, bet_amount=25.0)]
    ),
    (
        6, 10, None,
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 6, bet_amount=25.0)],
    ...
    (
        ...
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0)],
        (4, 5),
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 9, bet_amount=20.0)]
    ),
    (
        9, 6, None,
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 9, bet_amount=20.0)],
    ...
    (
        ...
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0)],
        (2, 2),
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 4, bet_amount=15.0)]
    ),
    (
        None, 4, None,
        [],
    ...
    (
        ...
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0)],
        (4, 6),
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 10, bet_amount=15.0)]
    ),
    (
        10, 6, None,
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 10, bet_amount=15.0)],
    ...
    (
        ...
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0)],
        (2, 6),
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 8, bet_amount=25.0)]
    ),
    (
        8, 9, None,
        [PassLine(bet_amount=5.0), DontPass(bet_amount=5.0), Odds(PassLine, 8, bet_amount=25.0)],
